...
TEST_CASE("Brick generator generates correct number of rows") {
  SECTION("Single row") {
    ...
    bricks_vec bricks = BrickGen::GenerateBricks(1, top_right, bottom_left, 1);
  ...
  SECTION("Two rows") {
    dvec2 top_right(100, 10);
    dvec2 bottom_left(10, 100);
    bricks_vec bricks = BrickGen::GenerateBricks(2, top_right, bottom_left, 1);
  ...
  SECTION("Multiple rows") {
    ...
    bricks_vec bricks = BrickGen::GenerateBricks(3, top_right, bottom_left, 1);
...
TEST_CASE("All bricks have the correct strength") {
  dvec2 top_right(100, 0);
  dvec2 bottom_left(0, 100);
  bricks_vec bricks = BrickGen::GenerateBricks(3, top_right, bottom_left, 3);
