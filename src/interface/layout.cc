...
const dvec2 Layout::kEasyModeButtonTopRight = dvec2(300, 800);
const dvec2 Layout::kEasyModeButtonBottomLeft = dvec2(600, 1100);

const dvec2 Layout::kClassicModeButtonTopRight = dvec2(1800, 800);
const dvec2 Layout::kClassicModeButtonBottomLeft = dvec2(2100, 1100);
}  // namespace breakout